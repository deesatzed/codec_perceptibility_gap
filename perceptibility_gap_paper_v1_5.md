...
Manuscript v1.5. Preregistered program. May 31, 2026.  
Extends: *The Codec Ceiling* (Satz, 2026). Supersedes v1.4; changes summarized in Section 0.
...
To derisk the estimator-class blind spot before any pre-registration freeze, the direct-ceiling and throughput-invariance probes were re-run under both Ridge (developmental) and the proposed confirmatory MLP, **on the exposed developmental families only; the reserved confirmatory holdout was never read** (eight seeds, `Delta_eq = 0.03`):
